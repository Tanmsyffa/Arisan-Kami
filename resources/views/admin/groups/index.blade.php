...
<a href="{{ route('admin.groups.create') }}" class="mb-4 inline-block bg-indigo-600 text-white px-4 py-2 rounded">
    + Tambah Grup
</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">
                <a href="{{ route('admin.groups.edit', $group) }}" class="text-blue-600 mr-2">Edit</a>
